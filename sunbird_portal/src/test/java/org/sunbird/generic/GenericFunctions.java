...
public class GenericFunctions extends BaseTest{
 ...
 // Method to get value of element
	...
	{
		String get = GenericFunctions.readFromNotepad("./TestData/courseNumbers.txt");
		int var=Integer.parseInt(get);
		System.out.println("Reading "+var);
		var=++var;
		String var1 = Integer.toString(var);
		GenericFunctions.writeNotepad(var1,"./TestData/courseNumbers.txt");
		String set=GenericFunctions.readFromNotepad("./TestData/courseNumbers.txt");
