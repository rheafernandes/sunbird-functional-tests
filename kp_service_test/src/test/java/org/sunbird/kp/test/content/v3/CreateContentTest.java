...
public class CreateContentTest extends BaseCitrusTestRunner {
    ...
    public void testCreateResourceContentWithValidRequest(String testName) {
        ...
        performPostTest(this, TEMPLATE_DIR, testName, APIUrl.CREATE_CONTENT, null,
    ...
    public void testCreateResourcePdfContentWithDuplicateIdentifier() {
        ...
        performPostTest(this, TEMPLATE_DIR, ContentV3Scenario.TEST_CREATE_RESOURCE_PDF_CONTENT_WITH_DUPLICATE_IDENTIFIER,
                APIUrl.CREATE_CONTENT, null, REQUEST_JSON, MediaType.APPLICATION_JSON, HttpStatus.BAD_REQUEST, null, RESPONSE_JSON);
    }
    ...
    public void testCreatePluginContent(String testName, Boolean valid, HttpStatus httpStatus) {
        ...
        getAuthToken(this, Constant.CREATOR);
        performPostTest(this, TEMPLATE_DIR, testName, APIUrl.CREATE_CONTENT, null, REQUEST_JSON,
                MediaType.APPLICATION_JSON, httpStatus, null, RESPONSE_JSON);
        if (valid) {
            performGetTest(this, TEMPLATE_DIR, testName, APIUrl.READ_CONTENT + identifier, null,
                    HttpStatus.OK, null, VALIDATE_JSON);
        }
