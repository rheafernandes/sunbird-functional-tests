...
public class GetSystemSettingTest extends BaseCitrusTestRunner {
    ...
    public static final String TEST_NAME_GET_SYSTEM_SETTING_SUCCESS =
            "testGetSystemSettingSuccess";

    public static final String TEMPLATE_DIR = "templates/systemsetting/get";

    private String getGetSystemSettingUrl(String field) {
        return getLmsApiUriPath("/api/data/v1/system/setting/get", "/v1/system/setting/get", field);
    }
    ...
    public Object[][] getSystemSettingDataProvider() {
        ...
        return new Object[][] {
                ...
                new Object[] {
                        TEST_NAME_GET_SYSTEM_SETTING_SUCCESS,
                        "uniqueField",
                        true,
                        HttpStatus.OK
                }
    ...
    @CitrusTest
    public void testGetSystemSetting(String testName,String field, boolean isAuthRequired, HttpStatus httpStatusCode) {
        performGetTest(
                this,
                TEMPLATE_DIR,
                testName,
