...
public class UserBulkUploadTest extends BaseCitrusTest {
  ...
  public Object[][] userBulkUploadSuccessDataProvider() {
    return new Object[][] {new Object[] {"testUserBulkUploadSuccess"}};
  }

  @DataProvider(name = "userBulkUploadFailureDataProvider")
  public Object[][] userBulkUploadFailureDataProvider() {
    return new Object[][] {
      new Object[] {"testUserBulkUploadFailureWithInvalidColumn", HttpStatus.BAD_REQUEST},
      new Object[] {"testUserBulkUploadFailureWithEmptyCsvFile", HttpStatus.BAD_REQUEST},
      new Object[] {"testUserBulkUploadFailureWithoutCsvFile", HttpStatus.BAD_REQUEST},
      new Object[] {"testUserBulkUploadFailureWithoutOrgDetails", HttpStatus.BAD_REQUEST}
    };
  }
