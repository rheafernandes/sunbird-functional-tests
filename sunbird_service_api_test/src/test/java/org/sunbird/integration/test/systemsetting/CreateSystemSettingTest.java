...
public class CreateSystemSettingTest extends BaseCitrusTestRunner {
    ...
    public static final String TEST_NAME_CREATE_SYSTEM_SETTING_FAILURE_WITHOUT_TOKEN =
            "testCreateSystemSettingFailureWithoutToken";
    ...
    private String getCreateSystemSettingUrl() {
        return getLmsApiUriPath("/api/data/v1/system/settings/set", "/v1/system/setting/set");
    }
    ...
    public Object[][] createSystemSettingDataProvider() {
        ...
        return new Object[][] {
                new Object[] {
                        TEST_NAME_CREATE_SYSTEM_SETTING_FAILURE_WITHOUT_TOKEN,
                        false,
                        HttpStatus.UNAUTHORIZED
                },
                new Object[] {
                        TEST_NAME_CREATE_SYSTEM_SETTING_FAILURE_WITHOUT_ID,
                        true,
                        HttpStatus.BAD_REQUEST
                },
                new Object[] {
                        TEST_NAME_CREATE_SYSTEM_SETTING_FAILURE_WITHOUT_FIELD,
                        true,
                        HttpStatus.BAD_REQUEST
                },
                new Object[] {
                        TEST_NAME_CREATE_SYSTEM_SETTING_FAILURE_WITHOUT_VALUE,
                        true,
                        HttpStatus.BAD_REQUEST
                },
                new Object[] {
                        TEST_NAME_CREATE_SYSTEM_SETTING_SUCCESS,
                        true,
                        HttpStatus.OK
                }
        };
