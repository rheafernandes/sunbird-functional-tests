...
public class ListIssuerTest extends BaseCitrusTestRunner {
  ...
  private static final String TEST_NAME_LIST_ISSUER_SUCCESS = "testListIssuerSuccess";
  ...
  public void testListIssuerSuccess(String testName) {
    beforeTest();
    performGetTest(
        this, TEMPLATE_DIR, testName, getListIssuerUrl(), false, HttpStatus.OK, RESPONSE_JSON);
    afterTest();
  }
