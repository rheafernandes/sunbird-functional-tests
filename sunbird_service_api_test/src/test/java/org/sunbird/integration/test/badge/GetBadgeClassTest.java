...
public class GetBadgeClassTest extends BaseCitrusTestRunner {
  ...
  private static final String TEST_NAME_GET_BADGE_CLASS_SUCCESS = "testGetBadgeClassSuccess";
  ...
  private String getReadBadgeClassUrl(String pathParam) {
    return getLmsApiUriPath(
        "/api/badging/v1/issuer/badge/read", "/v1/issuer/badge/read", pathParam);
  }
  ...
  public Object[][] getBadgeClassDataProviderFailure() {
    return new Object[][] {
      new Object[] {
        TEST_NAME_GET_BADGE_CLASS_FAILURE_WITH_INVALID_ID, "invalid", Constant.RESPONSE_JSON
      },
