...
public class GetIssuerTest extends BaseCitrusTestRunner {
  ...
  private static final String TEST_NAME_GET_ISSUER_SUCCESS = "testGetIssuerSuccess";
  ...
  public Object[][] getIssuerDataProviderFailure() {
    return new Object[][] {
      new Object[] {
        TEST_NAME_GET_ISSUER_FAILURE_WITH_INVALID_ID, "invalid", Constant.RESPONSE_JSON
      },
